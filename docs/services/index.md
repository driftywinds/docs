...
- [My forum](https://forum.drifty.win) - Alot of BETA releases and experimental patch builds are released here
- [Android](android.md)
- [iOS](ios.md)
...
- [Koreader Sync Server](https://kosync.003274.xyz) - My Koreader Sync server, compatible with Koreader on any device and Readest on any device
- [Telecoin Bot](https://003274.xyz/telecoin) - A Telegram bot that takes a Minecraft Bedrock Marketplace addon UUID or link as input and gives you the add on files for free. Most popular Marketplace addons available. 
...
- [ha.mr instance](https://pcmb.fyi) (compress links (not shorten), based on PortalRunner video here - https://pcmb.fyi/#b~9nFB([Ccz4dv.A*PQW# ([repo](https://pcmb.fyi/#OhvUjZg4]p;g))
...
- [Anchor Instance](https://anchor.003274.xyz) (closed to the public, accounts on request)
